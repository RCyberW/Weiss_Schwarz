...
public abstract class Zone extends Component implements MouseListener, Serializable {
	 ...
	 */
	public Zone(String imageFileName, int xa, int ya, FieldZone zone, Player player) {
		...
		try {
			...
			x = (int) (xa * gamePlay.Game.gameScale);
			y = (int) ((ya + gamePlay.Game.translatedY) * gamePlay.Game.gameScale);
