...
public class CardOriginal extends JLabel
	...
	public void setCardBound2(int x, int y, int width, int height) {
		cardBound2 = new Rectangle((int) (x), (int) (y),
				(int) (width / gamePlay.Game.gameScale),
				(int) (height / gamePlay.Game.gameScale));
	}
	...
	public void paint(Graphics g, int x, int y, boolean isFaceUp,
		...
		try {
			...
			cardBound = new Rectangle((int) (x * gamePlay.Game.gameScale), (int) (y
					* gamePlay.Game.gameScale + gamePlay.Game.translatedY),
					(int) (cardImage.getWidth(null) * gamePlay.Game.gameScale),
					(int) (cardImage.getHeight(null) * gamePlay.Game.gameScale));
